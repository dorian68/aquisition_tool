...
def generate_fintech_executive_dashboard(
    csv_path: str | Path,
...
generate_crm_style_dashboard = generate_fintech_executive_dashboard
generate_dark_saas_dashboard = generate_fintech_executive_dashboard


def main() -> None:
    parser = argparse.ArgumentParser(description="Compatibility wrapper for the Fintech Executive dashboard template.")
    parser.add_argument("csv_path", help="Path to input CSV")
    parser.add_argument("output_path", nargs="?", default="fintech_executive_dashboard.xlsx", help="Path to output XLSX/XLSM")
    ...
    result = generate_fintech_executive_dashboard(
        args.csv_path,
        args.output_path,
